...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        ...
        先用30cc鮮奶（配方內的鮮奶浸泡活化）將速溶酵母浸泡活化。將A陽種撕成小塊加入，再一同攪拌至捲起階段即材料均勻不粘缸狀態（攪拌好麵溫爲27°C-28°C）。28°C室溫發酵60分鐘後密封冷藏發酵48小時（最好是用膠袋紮緊麪糰不留空隙）
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
      <ol>
        <li>先將中種麪糰取出撕成小塊放入攪拌缸中，與C料攪拌至有彈性，在加入奶油，打至完成階段即可（拉起成薄膜狀）；</li>
        <li>延續發酵 15 - 20分鐘； </li>
